...
class Ui_FaceRecognizer3000(object):
    def setupUi(self, FaceRecognizer3000):
        ...
        self.eigenvectors = QtWidgets.QSpinBox(self.centralwidget)
        self.eigenvectors.setGeometry(QtCore.QRect(150, 390, 48, 26))
        self.eigenvectors.setObjectName("spinBox")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(20, 390, 131, 17))
        self.label_2.setObjectName("eigenvectors")
